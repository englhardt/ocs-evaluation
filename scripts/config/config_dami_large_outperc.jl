...
experiment_name="dami_large_outperc"

data_dirs = ["ALOI", "Annthyroid", "InternetAds", "KDDCup99", "PageBlocks", "PenDigits", "SpamBase", "Waveform", "Wilt"]
...
threshold_strategies = [
    ...
    OutlierPercentageThresholdStrategy(0.25)
]
